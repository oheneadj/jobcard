        ...
        <div class="card-body">
          ...
          <form id="formAuthentication" class="mb-3" action="/register" method="POST">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="name" name="name" placeholder="Enter your name" autofocus value="<?= $_POST['name'] ?? ''?>" />
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="email" name="email" placeholder="Enter your email" value="<?= $_POST['email'] ?? ''?>"/>

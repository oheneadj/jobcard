  ...
  <div class="authentication-wrapper authentication-basic container-p-y">
    <div class="authentication-inner">
      ...
      <?php if(isset($errors['user'])) :?>
        <p class="text-white text-center p-2 bg-danger rounded"><?=$errors['user']; ?></p>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="mb-3">
            ...
            <input type="email" class="form-control" id="email" name="email" placeholder="Enter your email" value="<?= $_POST['email'] ?? ''?>" autofocus />

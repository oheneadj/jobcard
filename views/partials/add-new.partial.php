<div class="py-4">
                <div class="dropdown">
                    ...
                    <a class="dropdown-item d-flex align-items-center" href="/job/create">
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="/device/create">
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="/brand/create">
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="/model/create">

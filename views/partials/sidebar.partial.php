  ...
  <div class="sidebar-inner px-4 pt-3">
    <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
      <div class="d-flex align-items-center">
        ...
        <div class="d-block">
          <h2 class="h5 mb-3">Hi, <?= $_SESSION['user']['name'] ?? "" ?></h2>
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      <li class="nav-item">
        <a href="/dashboard" class="nav-link d-flex align-items-center">
          ...
          <span class="mt-1 ms-1 sidebar-text">Job Card</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a href="/brands"  class="nav-link d-flex justify-content-between">
          <span>
            <span class="sidebar-icon">
      ...
      <li class="nav-item">
        <a href="/models"  class="nav-link d-flex justify-content-between">
          <span>
            <span class="sidebar-icon">
      ...
      <li class="nav-item">
        <a href="<?= $_SESSION['user']['user_type'] == 1 ?   "/users": "/user?user={$_SESSION["user"]["id"]}" ?>" target="_blank" class="nav-link d-flex justify-content-between">
          <span>
            <span class="sidebar-icon">
            ...
            <span class="sidebar-text"><?= $_SESSION['user']['user_type'] == 1 ?   "Users" : "My Account" ?></span>
          </span>
          <span>
      ...
      <li class="nav-item">
        <a href="https://themesberg.com/docs/volt-bootstrap-5-dashboard/getting-started/quick-start/" target="_blank"
          ...
          <span class="sidebar-text">Settings <span class="badge badge-sm bg-secondary ms-1 text-gray-800">v1.4</span></span>
        </a>
      </li>
      <!-- <li class="nav-item">
      ...
      <li class="nav-item">
        <a href="https://arnsoninnovate.com"
        target="_blank"
